...
class LikeButton extends Component {
    ...
    render() {
        ...
        return (
            <div className='ml-autox' stylex={{top: '-40px', marginRight: '10px', WebkitTransition: 'all 2s .2s', MozTransition: 'all 2s .3s', transition: 'all 2s .3s'}}>
